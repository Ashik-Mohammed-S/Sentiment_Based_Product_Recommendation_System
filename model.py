...
class SentimentRecommenderModel:
    ...
    MODEL_NAME = "picklesentiment-classification-xg-boost-model.pkl"
    VECTORIZER = "pickletfidf-vectorizer.pkl"
    RECOMMENDER = "pickleuser_final_rating.pkl"
    CLEANED_DATA = "picklecleaned-data.pkl"
